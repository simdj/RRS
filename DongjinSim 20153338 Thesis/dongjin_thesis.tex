...
\State \Return Optimized $\bm{U}$ and $\bm{V}$
...
% 1-2) quality measure comparison
...
\hline
\multirow{2}{*}{Attack Size} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Naïve Quality Measure\end{tabular}} & \multicolumn{2}{c|}{Our Quality Measure} \\ \cline{2-5}
...
% 2) Prediction shift
% To compare the robustness of the recommendation models, we compute the prediction shift on the target items under attacks in the variety of attack sizes, filler sizes, and popular sizes.
