...
def parse_exp_title(exp_title):
	...
	if param_list[3].find('%')>-1:
		num_camo_item/=100.0
	pc = parameter_controller(embedding_dim=embedding_dim, attack_model=attack_model, num_fake_user=num_fake_user, num_fake_item=num_fake_item, num_camo_item=num_camo_item, exp_title=exp_title)
	return pc
